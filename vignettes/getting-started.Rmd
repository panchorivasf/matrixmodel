...
The `matrixmodel` package includes Shiny applications for interactive data exploration. You can view available apps and launch them:

```{r, eval=FALSE}
# View available apps
launch_app()

# Launch the plot selection app
# Note: This requires an interactive R session
launch_app("select")
```
