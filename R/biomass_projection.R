...
#'
#' @param save_to Directory where output files will be saved. Defaults to
...
#' @param data Data frame containing plot data with species and diameter
#'   group information.
...
#' @export
#'
biomass_projection <- function(save_to = NULL,
                               cores = -1,
                               data = NULL,
                               plot_id = NULL,
                               dbh_ref = NULL,
  ...
  if (!is.null(plot_id)){
    ...
    cat("Filtered to", nrow(t1), "plot(s) out of",
